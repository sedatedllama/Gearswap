...
function init_gear_sets()
	...
	sets.midcast['Enfeebling Magic'] = {main="Maxentius",sub="Vampirism",range=empty,ammo="Regal Gem",
		head="Malignance Chapaeu",neck="Dls. Torque +2",ear1="Malignance Earring",ear2="Enchanter's Earring +1",
	...
	sets.midcast['Enfeebling Magic'].Resistant = {main="Maxentius",sub="Vampirism",range=empty,ammo="Regal Gem",
		head="Malignance Chapaeu",neck="Dls. Torque +2",ear1="Malignance Earring",ear2="Enchanter's Earring +1",
		body="Jhakri Robe +2",hands="Jhakri cuffs +2",ring1="Stikini Ring +1",ring2="Stikini Ring +1",
		back=gear.nuke_jse_back,waist="Ovate Rope",legs="Jhakri slops +2",feet="Jhakri pigaches +2"}
