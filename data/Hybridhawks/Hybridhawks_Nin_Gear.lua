...
function user_job_setup()
	...
	state.Weapons:options('Savage','Heishi','MagicWeapons','ProcDagger','ProcSword','ProcGreatSword','ProcScythe','ProcPolearm','ProcGreatKatana','ProcKatana','ProcClub','ProcStaff')
...
function init_gear_sets()
    ...
    sets.precast.FC.Utsusemi = set_combine(sets.precast.FC, {neck="Magoraga Beads",body="Passion Jacket",feet="Hattori Kyahan +1",back={ name="Andartia's Mantle", augments={'STR+20','Accuracy+20 Attack+20','STR+10','Weapon skill damage +10%',}},})
    ...
    head={ name="Herculean Helm", augments={'Weapon skill damage +4%','STR+9','Accuracy+10','Attack+1',}},
    body={ name="Herculean Vest", augments={'Rng.Acc.+15','Weapon skill damage +4%',}},
    hands="Ken. Tekko +1",
    legs={ name="Herculean Trousers", augments={'Attack+8','Weapon skill damage +5%','STR+3',}},
    feet={ name="Herculean Boots", augments={'Weapon skill damage +4%','STR+9','Accuracy+12','Attack+1',}},
