...
function init_gear_sets()
    ...
    sets.precast.FC = {main="Cath Palug Hammer",sub="Chanter's Shield",ammo="Incantor stone",
		head="Bunzi's Hat",neck="Aceso's choker +1",ear1="Enchntr. Earring +1",ear2="Loquac. Earring",
		body="Inyanga Jubbah +2",hands="Gende. Gages +1",ring1="Prolix Ring",ring2="Kishar Ring",
    ...
    sets.precast.FC.DT = {main=gear.grioavolr_fc_staff,sub="Clerisy Strap +1",ammo="Impatiens",
		...
		body="Inyanga Jubbah +2",hands="Gende. Gages +1",ring1="Prolix Ring",ring2="Rahab Ring",
		back="Perimede Cape",waist={ name="Shinjutsu-no-Obi +1", augments={'Path: A',}},legs="Aya. Cosciales +2",feet="Regal Pumps +1"}
...
--    sets.Kiting = {feet="Herald's Gaiters"}
	...
	sets.Self_Healing = {neck="Clr. Torque +2",ring1="Kunaji Ring",ring2="Asklepian Ring",waist="Gishdubar Sash"}
	sets.Cure_Received = {neck="Clr. Torque +2",ring1="Kunaji Ring",ring2="Asklepian Ring",waist="Gishdubar Sash"}
	sets.Self_Refresh = {back="Grapevine Cape",waist="Gishdubar Sash",feet="Inspirited Boots"}

	-- Conserve Mp set for spells that don't need anything else, for set_combine.
	
	sets.ConserveMP = {main=gear.grioavolr_fc_staff,sub="Umbra Strap",ammo="Hasty Pinion +1",
		head="Vanya Hood",neck="Clr. Torque +2",ear1="Gifted Earring",ear2="Gwati Earring",
