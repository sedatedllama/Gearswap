...
function init_gear_sets()
    ...
    sets.precast.CorsairRoll = {range="Compensator", right_ring="Barataria Ring", back={ name="Camulus's Mantle", augments={'DEX+20','Accuracy+20 Attack+20','DEX+10','"Dbl.Atk."+10',}},}
    ...
    legs={ name="Herculean Trousers", augments={'Attack+29','"Triple Atk."+4',}},
