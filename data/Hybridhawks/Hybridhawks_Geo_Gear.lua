function user_job_setup()
	...
	gear.idle_jse_back = {name="Nantosuelta's Cape",augments={'Pet: "Regen"+10'}}
...
function init_gear_sets()
	...
	sets.precast.FC = {
		...
		ring1="Kishar Ring",
		ring2="Prolix Ring",
		back={ name="Lifestream Cape", augments={'Geomancy Skill +7','Indi. eff. dur. +20','Pet: Damage taken -1%',}},
		waist="Witful Belt",
		legs="Geo. Pants +1",
		feet="Regal Pumps +1"}
	...
	sets.midcast.Geomancy.Indi = set_combine(sets.midcast.Geomancy, {back="Lifestream Cape",legs="Bagua Pants +2",feet="Azimuth Gaiters +1"})
    ...
    sets.midcast.Drain = {main="Rubicundity",sub="Ammurapi Shield",ammo="Pemphredo Tathlum",
        ...
        back=gear.nuke_jse_back,waist="Austerity Belt +1",legs="Merlinic Shalwar",feet=gear.merlinic_aspir_feet}
	...
	sub="Oneiros Grip",
	head="Befouled Crown",
	neck="Chrys. Torque",ear1="Etiolation Earring",ear2="Ethereal Earring",
	...
	sets.idle.PDT = {main="Malignance Pole",sub="Umbra Strap",ammo="Staunch Tathlum +1",
		head="Telchine Cap",neck="Loricate Torque +1",ear1="Genmei Earring",ear2="Ethereal Earring",
...
--	sets.Kiting = {feet="Herald's Gaiters"}
	...
	-- Normal melee group
--	sets.engaged = {main="Trial Wand",ammo="Hasty Pinion +1",
...
--		back="Moonlight Cape",waist="Witful Belt",legs="Assid. Pants +1",feet="Battlecast Gaiters"}
	...
	sets.engaged.DW = {ammo="Hasty Pinion +1",
		head="Befouled Crown",neck="Asperity Necklace",ear1="Mache Earring +1",ear2="Mache Earring +1",
		body="Jhakri Robe +2",hands="Regal Cuffs",ring1="Ramuh Ring +1",ring2="Ramuh Ring +1",
		back="Moonlight Cape",waist="Windbuffet belt +1",legs="Assid. Pants +1",feet="Mallquis Clogs"}
