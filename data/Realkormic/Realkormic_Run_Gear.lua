function user_job_setup()
	...
	state.HybridMode:options('Normal','Tank_HP','Tank','DTLite')
...
function init_gear_sets()
    ...
    sets.precast.FC = {main="Malignance Sword",sub="",ammo="Impatiens",
	...
	sets.precast.FC.DT = {main="Malignance Sword",sub="",ammo="Impatiens",
	...
	sets.precast.WS = {ammo="Knobkierrie",
			...
			hands={ name="Herculean Gloves", augments={'Accuracy+26','"Triple Atk."+3','STR+3','Attack+14',}},
			waist="Fotia Belt",
			legs="Meg. Chausses +2",
    ...
    sets.midcast['Phalanx'] = set_combine(sets.midcast['Enhancing Magic'],{main="Deacon Sword",sub="",head="Futhark Bandeau +1",body=gear.taeon_phalanx_body,hands=gear.herculean_phalanx_hands,legs="Carmine Cuisses +1",feet=gear.herculean_nuke_feet})
    ...
    sets.idle = {main="",sub="Utu Grip",ammo="Homiliary",
		head="Rawhide Mask",neck="Loricate Torque +1",ear1="Genmei Earring",ear2="Ethereal Earring",
		body="Runeist's Coat +3",hands="Regal Gauntlets",ring1="Shneddick Ring",ring2="Stikini Ring +1",
