...
function init_gear_sets()
	...
	sets.precast.CorsairRoll["Chaos Roll"] = {
	head={ name="Lanun Tricorne +2", augments={'Enhances "Winning Streak" effect',}},
    body="Laksa. Frac +3",
    hands="Chasseur's Gants",
    legs="Meg. Chausses +2",
    ...
    sets.precast.WS = {
    head={ name="Herculean Helm", augments={'Accuracy+12 Attack+12','Weapon skill damage +4%','Accuracy+14','Attack+9',}},
    body="Laksa. Frac +3",
    hands="Meg. Gloves +2",
    legs="Meg. Chausses +2",
    feet={ name="Lanun Bottes +2", augments={'Enhances "Wild Card" effect',}},
    ...
    left_ring="Epaminondas's Ring",
    right_ring="Karieyh Ring",
    back={ name="Camulus's Mantle", augments={'STR+20','Accuracy+20 Attack+20','Weapon skill damage +9%',}},
	}
