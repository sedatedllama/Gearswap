...
--		legs="Leth. Fuseau +1",feet="Leth. Houseaux +1"}
	...
	sets.midcast['Enfeebling Magic'] = {main="Bunzi's Rod",sub="Ammurapi Shield",range=empty,ammo="Regal Gem",
		head="Viti. Chapeau +1",neck="Henic Torque",ear1="Malignance Earring",ear2="Enchanter's Earring +1",
		body="Atrophy Tabard +3",hands="Lethargy gantherots +1",ring1="Kishar Ring",ring2="Stikini Ring +1",
		back=gear.nuke_jse_back,waist="Ovate rope",legs="Chironic Hose",feet="Vitiation Boots +1"}
	...
	sets.weapons.DualWeaponsAcc = {main="Vampirism",sub="Maxentius",range=empty}
