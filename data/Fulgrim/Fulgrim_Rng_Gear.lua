...
function user_job_setup()
	...
	state.Weapons:options('Default','DualMagicWeapons','DualSavageWeapons','DualEviscerationWeapons','DualWeapons','DualMalevolence')
...
function init_gear_sets()
	...
	sets.weapons.DualMagicWeapons = {main="Naegling",sub="Tauret",range="Fomalhaut"}
