...
function init_gear_sets()
    ...
    sets.precast.JA['Elemental Siphon'] = {main="Nirvana",sub="Vox Grip",ammo="Esper Stone +1",
        neck="Incanter's Torque",ear1="Andoaa Earring",ear2="Lodurr Earring",
    ...
    sets.precast.BloodPactWard = {main="Nirvana",sub="Vox Grip",ammo="Sancus Sachet +1",
		head="Baayami Hat +1",neck="Incanter's Torque",ear1="Andoaa Earring",ear2="Lodurr Earring",
        body="Shomonjijoe +1",hands="Baayami Cuffs +1",ring1="Evoker's Ring",ring2="Stikini Ring +1",
        back="Conveyance Cape",waist="Kobo Obi",legs="Baayami Slops +1",feet="Baayami Sabots +1"}
		
    sets.precast.BloodPactRage = set_combine(sets.precast.BloodPactWard, {head="Convokers Horn +1"})

    -- Fast cast sets for spells
    
    sets.precast.FC = {main=gear.grioavolr_fc_staff,sub="",ammo="Impatiens",
		head="Amalric Coif +1",neck="Orunmila's Torque",ear1="Enchntr. Earring +1",ear2="Loquacious Earring",
		body="Inyanga Jubbah +2",hands={ name="Merlinic Dastanas", augments={'Mag. Acc.+21 "Mag.Atk.Bns."+21','"Fast Cast"+6','MND+1','Mag. Acc.+9','"Mag.Atk.Bns."+11',}},ring1="Kishar Ring",ring2="Prolix Ring",
    ...
    sets.midcast.FastRecast = {main=gear.grioavolr_fc_staff,sub="",ammo="Hasty Pinion +1",
	...
	sets.midcast['Summoning Magic'] = {ammo="Sancus Sachet +1",
   ...
   sets.midcast.Pet.PhysicalBloodPactRage = {
    ...
    hands={ name="Merlinic Dastanas", augments={'Pet: "Mag.Atk.Bns."+30','Blood Pact Dmg.+8','Pet: INT+3',}},
    ...
    hands={ name="Merlinic Dastanas", augments={'Pet: "Mag.Atk.Bns."+30','Blood Pact Dmg.+8','Pet: INT+3',}},
    legs={ name="Apogee Slacks +1", augments={'Pet: Attack+25','Pet: "Mag.Atk.Bns."+25','Blood Pact Dmg.+8',}},
    feet={ name="Apogee Pumps +1", augments={'Pet: Attack+25','Pet: "Mag.Atk.Bns."+25','Blood Pact Dmg.+8',}},
    neck={ name="Smn. Collar +2", augments={'Path: A',}},
    waist={ name="Shinjutsu-no-Obi +1", augments={'Path: A',}},
    left_ear="Gelos Earring",
    ...
    -- Idle sets
    sets.idle = {main="Nirvana",sub="Elan Strap +1",ammo="Staunch Tathlum +1",
        head="Convoker's Horn +1",neck="Loricate Torque +1",ear1="Gelos Earring",ear2="Ethereal Earring",
        body="Shomonjijoe +1",hands=gear.merlinic_refresh_hands,ring1="Stikini Ring +1",ring2="Stikini Ring +1",
        back="Umbra Cape",waist="Regal Belt",legs="Assid. Pants +1",feet="Herald's Gaiters"}

    sets.idle.PDT = {ammo="Staunch Tathlum +1",
        head="Convoker's Horn +1",neck="Loricate Torque +1",ear1="C. Palug Earring",ear2="Ethereal Earring",
    ...
    sets.idle.Avatar = {main="Niravana",sub="Elan Strap +1",ammo="Sancus Sachet +1",
    ...
    sets.idle.PDT.Avatar = {ammo="Sancus Sachet +1",
        head="Beckoner's Horn +1",neck="Loricate Torque +1",ear1="C. Palug Earring",ear2="Evans Earring",
        body="Shomonjijoe +1",hands=gear.merlinic_refresh_hands,ring1="Defending Ring",ring2="Dark Ring",
        back="Moonlight Cape",waist="Regal Belt",legs="Assid. Pants +1",
		feet={ name="Apogee Pumps +1", augments={'Pet: Attack+25','Pet: "Mag.Atk.Bns."+25','Blood Pact Dmg.+8',}},
		}

    sets.idle.Spirit = {main="Nirvana",sub="Umbra Strap",ammo="Sancus Sachet +1",
        head="Convoker's Horn +1",neck="Caller's Pendant",ear1="C. Palug Earring",ear2="Ethereal Earring",
    ...
    sets.idle.PDT.Spirit = {ammo="Sancus Sachet +1",
    ...
    sets.defense.MDT = {ammo="Sancus Sachet +1",
        head="Beckoner's Horn +1",neck="Loricate Torque +1",ear1="Handler's Earring +1",ear2="Enmerkar Earring",
        body="Shomonjijoe +1",hands=gear.merlinic_refresh_hands,ring1="Defending Ring",ring2="Dark Ring",
        back="Moonlight Cape",waist="Regal Belt",legs="Assid. Pants +1",feet="Baayami Sabots"}

    sets.defense.MEVA = {ammo="Sancus Sachet +1",
