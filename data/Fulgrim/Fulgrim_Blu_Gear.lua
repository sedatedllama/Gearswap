...
--	sets.precast.WS['Savage Blade'].DT = set_combine(sets.precast.WS.DT, {back=gear.wsd_jse_back})
	...
	sets.idle = {main="Bolelabunga",sub="Genmei Shield",ammo="Staunch Tathlum +1",
			      ...
			      back="Moonlight Cape",waist="Flume Belt +1",legs="Lengo Pants",feet=gear.herculean_refresh_feet}
	...
	sets.TreasureHunter = set_combine(sets.TreasureHunter, {ammo="Perfect Lucky Egg",head="White Rarab Cap +1",})
	...
	sets.weapons.Almace = {main="Naegling",sub="Iris"}
	...
	sets.weapons.HybridWeapons = {main="Maxentius",sub="Bunzi's Rod"}
