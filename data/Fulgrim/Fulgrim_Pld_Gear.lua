function user_job_setup()
	...
	state.Weapons:options('SakOchain','None','DeaconAegis','SakAegis','SequenceBlurred')
...
function init_gear_sets()
	...
	sets.weapons.SakAegis = {main="Sakpata's Sword",sub="Aegis"}
	sets.weapons.DualWeapons = {main="Sequence",sub="Demersal Degen +1"}
	sets.weapons.SakOchain = {main="Sakpata's Sword",sub="Ochain"}
