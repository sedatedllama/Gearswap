function user_job_setup()
	...
	state.Weapons:options('SwordBoard','Chango','Normal')
...
function init_gear_sets()
    ...
    sets.precast.WS = {
    ammo="Knobkierrie",
    head={ name="Odyssean Helm", augments={'Accuracy+20','Weapon skill damage +5%',}},
    body={ name="Odyss. Chestplate", augments={'Accuracy+24','Weapon skill damage +5%','AGI+9',}},
    hands={ name="Odyssean Gauntlets", augments={'Weapon skill damage +5%','Attack+8',}},
    legs={ name="Valorous Hose", augments={'Weapon skill damage +5%','DEX+5','Attack+6',}},
	...
	sets.precast.WS.SomeAcc = set_combine(sets.precast.WS, {back="Letalis Mantle",ring1="Chirich Ring +1",ring2="Chirich Ring +1",})
	sets.precast.WS.Acc = set_combine(sets.precast.WS, {neck="Combatant's Torque",ear1="Mache earring +1",ear2="Mache earring +1",ring1="Chirich Ring +1",ring2="Chirich Ring +1",})
...
-- Ragnarok melee sets
	...
	-- Weapons sets
	sets.weapons.SwordBoard = {main="Naegling",sub="Blurred Shield +1"}
